    ...
    public partial class MappingConfig
    {
        ...
        public static void Garanties()
        {
            ...
            Mapper.CreateMap<DbGarantie, Garantie>()
                ...
                .ForMember(dest => dest.GarDebut, opt => opt.MapFrom(src => src.Date_Debut_Risque))
                .ForMember(dest => dest.GarFin, opt => opt.MapFrom(src => src.Date_Fin_Risque))
                .ForMember(dest => dest.CplMontant, opt => opt.MapFrom(src => src.Montant_Risque_Compl))
                .ForMember(dest => dest.CplDebut, opt => opt.MapFrom(src => src.Periode_Debut))
                .ForMember(dest => dest.CplFin, opt => opt.MapFrom(src => src.Periode_Fin))
            ...
            Mapper.CreateMap<Garantie, DbGarantie>()
                ...
                .ForMember(dest => dest.Date_Debut_Risque, opt => opt.MapFrom(src => src.GarDebut))
                .ForMember(dest => dest.Date_Fin_Risque, opt => opt.MapFrom(src => src.GarFin))
                .ForMember(dest => dest.Montant_Risque_Compl, opt => opt.MapFrom(src => src.CplMontant))
                .ForMember(dest => dest.Periode_Debut, opt => opt.MapFrom(src => src.CplDebut))
                .ForMember(dest => dest.Periode_Fin, opt => opt.MapFrom(src => src.CplFin))
